...
To launch save all files with extension *.ps1  and config.txt file in the same folder on a local computer, change config to your needs and run subspace_advanced_CLI_monitor.ps1 file. Ensure that you have read the pre-requisites below.
    ...
    <p><img src="https://github.com/irbujam/images/blob/main/summary.PNG" width="640" hieght="380" /><img src="https://github.com/irbujam/images/blob/main/web.JPG" width="300" hieght="350" />
    <img src="https://github.com/irbujam/images/blob/main/detail.PNG" width="640" hieght="380" /></p>
