...
A simple to run and lightweight windows powershell script that captures live information from advanced CLI farmer and node metrics endpoint (farmer and node themselves can run on any OS).
